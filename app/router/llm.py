...
agent_with_tools_graph = ChatGraph(llm=ChatLLM().get_openai_llm(model_name=MODEL_VERSION), tools=[check_fitosanitarios,save_record,create_record,get_current_date,available_fitosanitarios]).graph()
